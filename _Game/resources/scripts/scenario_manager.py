...
# Music
ending_music = os.path.join(music_path, 'ending.ogg')
free_period_music = os.path.join(music_path, 'free_period.ogg')
lecture_music = os.path.join(music_path, 'lecture.ogg')
meet_the_boss_music = os.path.join(music_path, 'meet_the_boss.ogg')
office_music = os.path.join(music_path, 'office.ogg')
staff_room_music = os.path.join(music_path, 'staff_room.ogg')
workshop_music = os.path.join(music_path, 'workshop.ogg')
